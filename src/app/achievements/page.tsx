...
export default function AchievementsPage() {
  return (
    <>
      ...
      <Section background="light">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-6">Our Achievements &amp; Certifications</h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            We&apos;re proud of our accomplishments and the trust our clients place in us. 
            Here are some of our notable achievements and certifications.
          </p>
        </div>
