    ...
    <>
      ...
      <Section background="gradient" paddingY="md" className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="relative h-64 md:h-96 w-full max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-2xl">
            <Image
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div 
                key={index}
                className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1"
              >
      ...
      <Section background="dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-t-blue-500 group hover:-translate-y-1"
            >
      ...
      <Section background="light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white p-8 rounded-2xl shadow-xl relative overflow-hidden group border border-gray-100 hover:shadow-2xl transition-all duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div 
              key={index} 
              className={`bg-white p-6 rounded-xl shadow-lg hover:shadow-xl border-b-4 ${value.color === 'blue' ? 'border-blue-500' : value.color === 'purple' ? 'border-purple-500' : value.color === 'teal' ? 'border-teal-500' : 'border-amber-500'}`}
            >
              <div className={`w-16 h-16 ${value.color === 'blue' ? 'bg-blue-100' : value.color === 'purple' ? 'bg-purple-100' : value.color === 'teal' ? 'bg-teal-100' : 'bg-amber-100'} rounded-xl flex items-center justify-center mb-4`}>
